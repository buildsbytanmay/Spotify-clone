...
// Making fullScreen Playbar
document.querySelector(".playBar").addEventListener("click", (e) => {
    e.currentTarget.classList.add("fullScreen");
    document.querySelector(".imagediv").removeAttribute("style");
    document.querySelector(".imagediv").style.backgroundImage = `url(/${currFolder}/cover.jpg)`;

    document.querySelector(".fullScreenHead").removeAttribute("style");
    document.querySelector(".fullScreenHead").innerHTML = downChevronSvg;
    
    document.querySelector(".upperBar").classList.add("upperBar1");
    document.querySelector(".play").classList.add("btns1");
    document.querySelector(".previous").classList.add("btns2");
    document.querySelector(".next").classList.add("btns3");

    document.querySelector(".time").removeAttribute("style");

    pauseSvg =  `<svg width="70" height="70" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 7C4 5.58579 4 4.87868 4.43934 4.43934C4.87868 4 5.58579 4 7 4C8.41421 4 9.12132 4 9.56066 4.43934C10 4.87868 10 5.58579 10 7V17C10 18.4142 10 19.1213 9.56066 19.5607C9.12132 20 8.41421 20 7 20C5.58579 20 4.87868 20 4.43934 19.5607C4 19.1213 4 18.4142 4 17V7Z" stroke="currentColor" stroke-width="1.5"/>
                    <path d="M14 7C14 5.58579 14 4.87868 14.4393 4.43934C14.8787 4 15.5858 4 17 4C18.4142 4 19.1213 4 19.5607 4.43934C20 4.87868 20 5.58579 20 7V17C20 18.4142 20 19.1213 19.5607 19.5607C19.1213 20 18.4142 20 17 20C15.5858 20 14.8787 20 14.4393 19.5607C14 19.1213 14 18.4142 14 17V7Z" stroke="currentColor" stroke-width="1.5"/>
                </svg>`;

    document.querySelector(".btns1").firstElementChild.setAttribute("width", "70");
    document.querySelector(".btns1").firstElementChild.setAttribute("height", "70");
    document.querySelector(".play").addEventListener("click", () => {
        document.querySelector(".play").firstElementChild.setAttribute("width", "70");
        document.querySelector(".play").firstElementChild.setAttribute("height", "70");
    })
    document.querySelector(".btns2").firstElementChild.setAttribute("width", "50");
    document.querySelector(".btns2").firstElementChild.setAttribute("height", "50");
    document.querySelector(".btns3").firstElementChild.setAttribute("width", "50");
